 ...
 *               type:
 *                 type: string
 *                 enum: [LIKE, LOVE, HAHA, WOW, SAD, ANGRY, USEFUL]
 ...
 *               $ref: '#/components/schemas/Error'
 *       409:
 *         description: User has already reacted with this type
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
 ...
 * /posts/{id}/pin:
 *   put:
 *     summary: Toggle pin status of a post (admin/moderator only)
 *     tags: [Posts]
 *     security:
 *       - bearerAuth: []
 *     parameters:
